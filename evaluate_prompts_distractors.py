...
if __name__=="__main__":
    ...
    # distractors: add queries back:
    corpus = datasets.concatenate_datasets([corpus, queries])
    ...
    options.save_path =  f'{options.save_prefix}/{model_name_}/{data_safe_name}{"_lang_specific" if options.use_lang_specific_prompts else ""}/{options.split}/{options.template}_template/results@{options.k}_w_distractors.json'
