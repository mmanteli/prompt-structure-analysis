...
NON_LANG_DATASETS=("mteb/ARCChallenge" "summeval-2" "squad")
    ...
    for template in "Instruct-Query"; do
        for model in "${MODELS[@]}"; do
            ...
            for data in "${DATASETS[@]}"; do
                ...
                sbatch --job-name="eval_squad/${safe_model}_${safe_data}_${split}_${template}" \
                       -t 02:59:59 \
                ...
                if is_lang_specific_data "$data"; then
                    ...
                    sbatch --job-name="eval_squad/${safe_model}_${safe_data}_${split}_${template}_lang_specific" \
                           -t 02:59:59 \
                           slurm_run_command_gpu.sh "${CMD[@]}"
                fi
            done
